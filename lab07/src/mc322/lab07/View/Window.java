...
public class Window extends JFrame{
	...
	Window(){
		...
		this.contentPane.add(new TextLabel(StateMachineController.instance.getPlayer1().name, 75, 10, 300, 20, 17, 255, 255, 255));
		this.contentPane.add(new TextLabel(StateMachineController.instance.getPlayer2().name, 75, 728, 300, 20, 17, 255, 255, 255));
